...
function Navbar() {
  ...
  //new
  // Create state for the sub-menu
  const [subMenuAnchorEl, setSubMenuAnchorEl] = React.useState(null);
  const subMenuOpen = Boolean(subMenuAnchorEl);

  // Open the sub-menu when the NavButton is clicked
      ...
      <Inner>
        ...
        <RightContainer>
          ...
          >
            ...
            {/* new */}
            {/* <MenuItem  onClick={user ? () => signOut() : () => navigate("/login")} >Sign Out</MenuItem> */}
            {user ? (
